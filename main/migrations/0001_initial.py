    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_activated', models.BooleanField(db_index=True, default=False, help_text='Пользователь, прошедший процесс подтверждения', verbose_name='Статус подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField(help_text='Описание возможного ответа', verbose_name='Ответ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, help_text='Предмет, знания которого проверяются в тесте', max_length=25, verbose_name='Название')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Короткое название теста', max_length=100, verbose_name='Название ')),
                ...
                ('content', models.TextField(help_text='Детальное описание теста', verbose_name='Описание')),
                ('is_active', models.BooleanField(db_index=True, default=False, help_text='Вопросы составлены и тест готов к публикации', verbose_name='Статус публикации')),
                ('public_at', models.DateTimeField(blank=True, db_index=True, default=None, help_text='Дата публикации теста', verbose_name='Дата публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.FloatField(default=1.0, help_text='Количество балов начисленных за правильный ответ', verbose_name='Оценка за ответ')),
                ...
                ('type_answer', models.BooleanField(default=False, help_text='Дать возможность выбора нескольких вариантов ответа', verbose_name='Множественный выбор')),
