    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='answers_modified', to=settings.AUTH_USER_MODEL, verbose_name='Последнее изменение')),
            ],
            options={
                'verbose_name': 'Ответ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lessons_modified', to=settings.AUTH_USER_MODEL, verbose_name='Последнее изменение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, help_text='Короткое название теста', max_length=100, verbose_name='Название ')),
                ...
                ('content', models.TextField(db_index=True, help_text='Детальное описание теста', verbose_name='Описание')),
                ...
                ('public_at', models.DateTimeField(blank=True, db_index=True, default=None, help_text='Дата публикации теста на сайте', null=True, verbose_name='Дата публикации')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tasks', to=settings.AUTH_USER_MODEL, verbose_name='Автор теста')),
                ('last_modified', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tasks_modified', to=settings.AUTH_USER_MODEL, verbose_name='Последнее изменение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_score', models.PositiveIntegerField(blank=True, db_index=True, default=None, verbose_name='Оценка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField(help_text='Описание задаваемого вопроса в тесте', verbose_name='Вопрос')),
                ...
                ('is_active', models.BooleanField(db_index=True, default=True, help_text='Учитывать вопрос в тесте', verbose_name='Вопрос учтен')),
                ('last_modified', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='questions_modified', to=settings.AUTH_USER_MODEL, verbose_name='Последнее изменение')),
