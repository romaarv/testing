...
from .views import (index, other_page, profile, ChangeUserInfoView, TestingLogoutView, TestingLoginView,
    TestingPasswordChangeView, RegisterUserView, RegisterDoneView, user_activate,)
